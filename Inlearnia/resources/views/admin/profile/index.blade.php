...
@section('content')
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-[300px] flex-shrink-0 flex flex-col gap-5">
            ...
            <div class="bg-white rounded-[20px] shadow-sm border border-slate-200 overflow-hidden">
                ...
                {{-- Tombol edit sekolah --}}
                <div class="px-6 pb-5">
                    <a href="{{ route('admin.profile.school.edit') }}"
                        class="w-full bg-slate-50 hover:bg-[#0F4C5C] hover:text-white text-slate-600 border border-slate-200 hover:border-[#0F4C5C] px-4 py-2 rounded-[10px] text-[12px] font-semibold transition-all duration-200 flex items-center justify-center gap-2">
                        Edit Data Sekolah
                    </a>
                </div>
            </div>
        ...
        <div class="flex-1 flex flex-col gap-5">
            ...
            <div class="bg-white rounded-[20px] shadow-sm border border-slate-200 p-7">
                <div class="flex items-center gap-2 mb-6 pb-4 border-b border-slate-100">
                    ...
                    <h3 class="text-[#092C4C] text-[16px] font-semibold">Informasi Admin</h3>
                </div>
                ...
                <div class="flex items-center gap-5 mb-6">
                    ...
                    <div>
                        ...
                        <span
                            class="bg-red-100 text-red-600 text-[11px] font-semibold px-3 py-0.5 rounded-full">Admin</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-8">
                    ...
                    <div>
                        <label class="block text-[10px] text-slate-400 uppercase tracking-wider mb-1">Bergabung
                            Sejak</label>
                        <div class="text-[#092C4C] font-medium text-[14px]">
    ...
    <x-ui.modal-form id="modalEditProfile" title="Edit Profil Admin" description="Perbarui data akun admin"
