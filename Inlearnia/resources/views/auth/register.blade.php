        ...
        <div class="relative z-10 flex min-h-[calc(100vh-96px)] px-10">
            ...
            <div class="w-1/3 flex items-center justify-center -translate-y-14">
                <ol class="relative flex flex-col gap-10">
                    <li class="stepper-item relative pl-10" data-step="1">
                        <span class="step-circle absolute left-0 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-teal-500 text-xs font-semibold z-10">
                            1
                        </span>
                    ...
                    <li class="stepper-item relative pl-10 opacity-40" data-step="2">
                        <span class="step-circle absolute left-0 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-[#092C4C] border border-white/20 text-xs z-10">
                            2
                        </span>
                    ...
                    <li class="stepper-item relative pl-10 opacity-40" data-step="3">
                        <span class="step-circle absolute left-0 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-[#092C4C] border border-white/20 text-xs z-10">
                            3
                        </span>
                    ...
                    <li class="stepper-item relative pl-10 opacity-40" data-step="4">
                        <span class="step-circle absolute left-0 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-[#092C4C] border border-white/20 text-xs z-10">
                            4
                        </span>
                    ...
                    <x-step.layout title="Buat Password Anda" subtitle="Buat password untuk akun Anda">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="fade-in-up" style="animation-delay:0.6s">
                                <x-form.password name="password_confirmation" id="confirm-password" placeholder="Konfirmasi password" />
                            </div>
                        </div>
                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="button" onclick="goToStep(3)">Lanjutkan</x-logres.primary-button>
                            <x-logres.secondary-button type="button" onclick="goToStep(1)">Kembali</x-logres.secondary-button>
                        </div>
                ...
                <div class="step-content step-3 hidden flex justify-center pt-24 min-h-full">
                    <x-step.layout title="Masukkan Nama Anda" subtitle="Masukkan nama Anda sebagai administrator sekolah">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="fade-in-up" style="animation-delay:0.5s">
                                <x-form.input name="name" type="text" placeholder="Masukkan nomor telepon" />
                            </div>
                        </div>
                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="button" onclick="goToStep(4)">Lanjutkan</x-logres.primary-button>
                            <x-logres.secondary-button type="button" onclick="goToStep(2)">Kembali</x-logres.secondary-button>
                        </div>
                ...
                <div class="step-content step-4 hidden flex justify-center pt-24 min-h-full">
                    <x-step.layout title="Data Sekolah" subtitle="Masukkan data sekolah yang ingin Anda daftarkan">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="fade-in-up" style="animation-delay:0.4s">
                                <textarea name="school_address" rows="3" class="w-full rounded-xl bg-transparent border border-white/30 px-5 py-3 focus:outline-none focus:border-[#00A6FF]" placeholder="Masukkan alamat sekolah"></textarea>
                            </div>
                        </div>
                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="submit">Selesai</x-logres.primary-button>
                            <x-logres.secondary-button type="button" onclick="goToStep(3)">Kembali</x-logres.secondary-button>
                        </div>
