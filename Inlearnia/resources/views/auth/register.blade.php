...
<body class="min-h-screen font-[Inter] text-white no-drag">
    ...
    <div class="relative min-h-screen bg-gradient-to-br from-[#031826] via-[#06253A] to-[#020B13] overflow-hidden">
        ...
        <!-- Background radial -->
        <div
            class="absolute inset-0 bg-[linear-gradient(90deg,#000000_0%,#000000_5%,#092C4C_45%,#000000_75%,#000000_100%)]">
        </div>
        ...
        <div class="relative z-10 flex min-h-[calc(100vh-96px)] px-10">
            ...
            <!-- LEFT : Stepper -->
            <div class="w-1/3 flex items-center justify-center -translate-y-14">

                <ol class="relative flex flex-col gap-10">

                    <!-- STEP 1 -->
                    <li class="stepper-item relative pl-10">
                        <span class="step-circle absolute left-0 top-1 flex h-6 w-6 items-center justify-center
                       rounded-full bg-teal-500 text-xs font-semibold z-10">
                            1
                        </span>

                        <h3 class="font-medium text-white">Masukkan Email</h3>
                        <p class="text-sm text-white/60">
                            Konfirmasi bahwa email itu milik Anda
                        </p>
                    ...
                    <!-- STEP 2 -->
                    <li class="stepper-item relative pl-10 opacity-40">
                        <span class="step-circle absolute left-0 top-1 flex h-6 w-6 items-center justify-center
                       rounded-full bg-[#092C4C] border border-white/20 text-xs z-10">
                            2
                        </span>
                    ...
                    <li class="stepper-item relative pl-10 opacity-40">
                       ...
                       rounded-full bg-[#092C4C] border border-white/20 text-xs z-10">
                        ...
                        <p class="text-sm text-white/60">
                            Masukkan nama Anda sebagai Administrator
                        </p>
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="w-2/3">
                ...
                <!-- ================= STEP 1 ================= -->
                <div class="step-content step-1 flex justify-center pt-24 min-h-full">

                    <x-step.layout title="Masukkan Email Anda"
                        subtitle="Masukkan alamat email yang valid untuk menerima kode">

                        <x-slot:icon>
                            <x-step-icon>
                                <!-- SVG TIDAK DIUBAH -->
                                <svg class="z-10" width="43" height="43" viewBox="0 0 43 43" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M33.6442 7.0835H8.85254C7.44358 7.0835 6.09232 7.6432 5.09603 8.63949C4.09975 9.63578 3.54004 10.987 3.54004 12.396V30.1043C3.54004 31.5133 4.09975 32.8645 5.09603 33.8608C6.09232 34.8571 7.44358 35.4168 8.85254 35.4168H33.6442C35.0532 35.4168 36.4044 34.8571 37.4007 33.8608C38.397 32.8645 38.9567 31.5133 38.9567 30.1043V12.396C38.9567 10.987 38.397 9.63578 37.4007 8.63949C36.4044 7.6432 35.0532 7.0835 33.6442 7.0835ZM33.6442 10.6252L22.1338 18.5408C21.8646 18.6962 21.5592 18.778 21.2484 18.778C20.9375 18.778 20.6322 18.6962 20.363 18.5408L8.85254 10.6252H33.6442Z"
                                        fill="white" />
                                </svg>
                            </x-step-icon>
                        </x-slot:icon>
                        ...
                        <div class="space-y-4">
                            <div class="fade-in-up" style="animation-delay:0.4s">
                                <x-form.input name="email" type="email" placeholder="Masukkan email" />
                            </div>
                        </div>
                        ...
                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="button" onclick="goToStep(2)">
                                Dapatkan Kode
                ...
                <!-- ================= STEP 2 ================= -->
                <div class="step-content step-2 hidden flex justify-center pt-24 min-h-full">

                    <x-step.layout title="Buat Password Anda"
                        subtitle="Buat password untuk akun Anda">
                        ...
                        <div class="space-y-4">
                            <div class="fade-in-up" style="animation-delay:0.5s">
                                <x-form.password name="password" id="password" placeholder="Masukkan password" />
                            </div>

                            <div class="fade-in-up" style="animation-delay:0.6s">
                                <x-form.password name="password_confirmation" id="confirm-password"
                                    placeholder="Konfirmasi password" />
                            </div>
                        </div>

                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="button" onclick="goToStep(3)">
                                Lanjutkan
                            </x-logres.primary-button>

                            <x-logres.secondary-button type="button" onclick="goToStep(1)">
                                Kembali
                            </x-logres.secondary-button>
                        </div>
                ...
                <!-- ================= STEP 3 ================= -->
                <div class="step-content step-3 hidden flex justify-center pt-24 min-h-full">

                    <x-step.layout title="Masukkan Nama Anda"
                        subtitle="Masukkan nama Anda sebagai administrator sekolah">
                        ...
                        <div class="space-y-4">
                            <div class="fade-in-up" style="animation-delay:0.4s">
                                <x-form.input name="name" type="text" placeholder="Masukkan nama lengkap" />
                            </div>
                        </div>

                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="button" onclick="goToStep(4)">
                                Lanjutkan
                            </x-logres.primary-button>
                ...
                <!-- ================= STEP 4 ================= -->
                <div class="step-content step-4 hidden flex justify-center pt-24 min-h-full">
                    ...
                    <x-step.layout title="Data Sekolah" subtitle="Masukkan data sekolah yang ingin Anda daftarkan">
                        ...
                        <div class="space-y-4">
                            ...
                            <label class="mb-6 border-2 border-dashed border-[#00A6FF] rounded-xl p-6
       h-[180px]
       flex items-center justify-center
       text-center cursor-pointer hover:border-teal-400 transition
       relative overflow-hidden">

                                <input type="file" name="school_logo" id="schoolLogoInput" accept="image/*"
                                    class="hidden" onchange="previewSchoolLogo(event)">

                                <!-- REMOVE BUTTON (POJOK KANAN ATAS AREA) -->
                                <button type="button" onclick="removeSchoolLogo(event)" id="removeLogoBtn" class="absolute top-3 right-3 hidden
               ...
               flex items-center justify-center text-xs z-10">
                                ...
                                <div id="uploadPlaceholder" class="flex flex-col items-center justify-center">
                                    <!-- SVG TIDAK DIUBAH -->
                                    <svg class="mx-auto mb-3" width="32" height="32" fill="none" viewBox="0 0 24 24"
                                        stroke="white">
                                    ...
                                    <p class="text-sm text-white/70">
                                        Drag & drop logo sekolah di sini<br>
                                        <span class="text-white/40">atau klik untuk upload</span>
                                    </p>
                                </div>
                            ...
                            <div class="fade-in-up" style="animation-delay:0.4s">
                                <x-form.input name="school_name" type="text" placeholder="Masukkan nama sekolah" />
                            </div>

                            <div class="fade-in-up" style="animation-delay:0.4s">
                                <textarea name="school_address" rows="3" class="w-full rounded-xl bg-transparent border border-white/30
                        ...
                        <div class="mt-8 space-y-4">
                            <x-logres.primary-button type="submit">
                                Selesai
                            </x-logres.primary-button>

                            <x-logres.secondary-button type="button" onclick="goToStep(2)">
                                Kembali
                            </x-logres.secondary-button>
    ...
    <script>
        ...
        function goToStep(step) {
            ...
            document.querySelectorAll('.stepper-item')
                .forEach((el, idx) => {
                    el.classList.toggle('opacity-40', idx + 1 > step);
                });
            ...
            steppers.forEach((el, idx) => {
                const circle = el.querySelector('span');
                const stepNum = idx + 1;

                if (stepNum < step) {
                    el.classList.remove('opacity-40');
                    circle.classList.remove('bg-[#092C4C]', 'border', 'border-white/20');
                    ...
                    circle.classList.remove('bg-teal-500');
                    circle.classList.add('bg-[#092C4C]', 'border', 'border-white/20');
                }
            });
        }
