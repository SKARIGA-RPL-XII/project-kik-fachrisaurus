            ...
            <div class="bg-white rounded-[15px] shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300 relative flex flex-col overflow-hidden group">
                ...
                <div class="px-[15px] pb-[15px] flex-1 flex flex-col">
                    <div class="flex justify-between items-start mb-1">
                        <h3 class="text-[18px] font-bold text-[#2d3748] leading-tight line-clamp-1 w-[75%]">
                            {{ $class->name }}
                        </h3>
                    ...
                    <div class="mt-auto">
                        <a href="{{ route('teacher.kelas.show', $class->id) }}" class="flex items-center justify-center w-full h-[40px] rounded-[8px] bg-[#00A79D] text-white text-sm font-medium hover:bg-[#008f87] transition-all shadow-sm shadow-teal-100">
                            Masuk Kelas
                        </a>
                    </div>
                </div>
